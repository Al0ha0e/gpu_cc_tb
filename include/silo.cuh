...
namespace cc
{
    ...
    union silo_timestamp_t
    {
        unsigned long long int ll;
        silo_timestamp_struct s;
    };

    struct silo_replica_entry
    {
...
#define SILO_REPLICA_ENTRIES 0
    ...
    private:
        void __device__ lock(silo_timestamp_t *entry)
        {
            while (true)
            {
...
#pragma unroll
            ...
            {
                silo_timestamp_t ts;
                ts.ll = ((volatile timestamp_t *)RS[i].entry)->ll;
