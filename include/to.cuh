...
#pragma unroll
            for (int i = 0; i < WCNT; i++)
            {
                ...
                to_timestamp_t *entry = winfo.tsp;
            ...
            size_t size)
        {
            ...
            do
            {
                ...
                volatile to_timestamp_t ts1, ts2;
